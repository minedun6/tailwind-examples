...
<head>
    ...
    <link rel="stylesheet" href="/css/resolute.css">
</head>
<body class="bg-grey-lighter font-sans antialiased text-grey-darker">
<div class="top-bar flex items-center py-4 bg-blue-resolute">
    <div class="logo-container w-left pl-4">
        <svg width="166px" height="32px" viewBox="0 0 166 32" version="1.1" xmlns="http://www.w3.org/2000/svg"
             xmlns:xlink="http://www.w3.org/1999/xlink">
            <defs></defs>
            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <g id="resolute" transform="translate(-21.000000, -21.000000)" fill="#FFFFFF" fill-rule="nonzero">
                    <g id="resolute-logo" transform="translate(21.000000, 21.000000)">
    ...
    <div class="relative w-full flex-1 pr-4">
        <div class="absolute pin-t flex items-center py-4 px-3 text-grey-darker">
        ...
        <input type="text"
               class="w-full px-4 py-4 pl-10 text-sm bg-grey-lighter border border-blue-resolute-dark outline-0"
...
<div class="three-columns flex">
        ...
        <ul class="list-reset text-sm border-b-2 border-grey-light">
            ...
            <li class="flex items-center py-2 pl-4 my-1 group-hover:text-black ">
                <span class="pr-2 text-blue-resolute-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                         class="fill-current">
                        <path class="heroicon-ui"
                              d="M8 4c0-1.1.9-2 2-2h4a2 2 0 0 1 2 2h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6c0-1.1.9-2 2-2h2zm0 2H6v14h12V6h-2a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2zm2-2v2h4V4h-4z"/></svg>
                </span>
            ...
            <li class="flex items-center py-2 pl-4 my-1  hover:text-black bg-white border-l-4 border-solid border-blue-resolute">
                <span class="pr-2 text-blue-resolute-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                         class="fill-current">
                        <path class="heroicon-ui"
                              d="M13 20v-5h-2v5a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-7.59l-.3.3a1 1 0 1 1-1.4-1.42l9-9a1 1 0 0 1 1.4 0l9 9a1 1 0 0 1-1.4 1.42l-.3-.3V20a2 2 0 0 1-2 2h-3a2 2 0 0 1-2-2zm5 0v-9.59l-6-6-6 6V20h3v-5c0-1.1.9-2 2-2h2a2 2 0 0 1 2 2v5h3z"/></svg>
                </span>
            ...
            <li class="flex items-center py-2 pl-4 my-1 hover:text-black ">
                <span class="pr-2 text-blue-resolute-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                         class="fill-current"><path class="heroicon-ui"
                                                    d="M11 14.59V3a1 1 0 0 1 2 0v11.59l3.3-3.3a1 1 0 0 1 1.4 1.42l-5 5a1 1 0 0 1-1.4 0l-5-5a1 1 0 0 1 1.4-1.42l3.3 3.3zM3 17a1 1 0 0 1 2 0v3h14v-3a1 1 0 0 1 2 0v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3z"/></svg>
                </span>
            ...
            <li class="flex items-center py-2 pl-4 my-1 hover:text-black ">
                ...
                <a href="#" class="text-grey-darker hover:text-black">Exports</a>
            </li>
        </ul>
        <ul class="list-reset text-sm border-grey-light border-solid pt-3">
            <li class="flex items-center py-2 pl-4 my-1 hover:text-black ">
                <span class="pr-2 text-blue-resolute-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                         class="fill-current"><path class="heroicon-ui"
                                                    d="M4 16v5a1 1 0 0 1-2 0V3a1 1 0 0 1 1-1h8.5a1 1 0 0 1 .7.3l.71.7H21a1 1 0 0 1 .9 1.45L19.11 10l2.77 5.55A1 1 0 0 1 21 17h-8.5a1 1 0 0 1-.7-.3l-.71-.7H4zm7-12H4v10h7.5a1 1 0 0 1 .7.3l.71.7h6.47l-2.27-4.55a1 1 0 0 1 0-.9L19.38 5H13v4a1 1 0 0 1-2 0V4z"/></svg>
                </span>
            ...
            <li class="flex items-center py-2 pl-4 my-1 hover:text-black ">
                <span class="pr-2 text-blue-resolute-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                         class="fill-current"><path class="heroicon-ui"
                                                    d="M13 16v5a1 1 0 0 1-1 1H9l-3-6a2 2 0 0 1-2-2 2 2 0 0 1-2-2v-2c0-1.1.9-2 2-2 0-1.1.9-2 2-2h7.59l4-4H20a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-2.41l-4-4H13zm0-2h1.41l4 4H20V4h-1.59l-4 4H13v6zm-2 0V8H6v2H4v2h2v2h5zm0 2H8.24l2 4H11v-4z"/></svg>
                </span>
            ...
            <li class="flex items-center py-2 pl-4 my-1 hover:text-black ">
                <span class="pr-2 text-blue-resolute-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"
                         class="fill-current"><path class="heroicon-ui"
                                                    d="M13 17h-2v2h2v-2zm2 0v2h2a1 1 0 0 1 0 2H7a1 1 0 0 1 0-2h2v-2H4a2 2 0 0 1-2-2V5c0-1.1.9-2 2-2h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-5zM4 5v10h16V5H4z"/></svg>
                </span>
            ...
            <li class="flex items-center py-2 pl-4 my-1 hover:text-black ">
                ...
                <a href="#" class="text-grey-darker hover:text-black">Logout</a>
            </li>
        </ul>
    </div> <!-- end left-sidebar -->

    <div class="middle-column w3/5 flex-1">
        <div class="breadcrumbs text-sm px-2 py-4 border-b-2 border-solid border-grey-light mb-8">
            <span class="px-2"><a href="#">Contacts</a></span>
            <span>
                <svg width="6px" height="10px" viewBox="0 0 6 10" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="fill-current">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="px-2 text-black">Properties</span>
        </div> <!-- end breadcrumbs -->

        <div class="px-4 container-resolute mx-auto">
            <div class="heading-section flex items-center mb-1">
                ...
                <h1 class="font-normal text-3xl mr-2">GALDZO2R4I5ZK</h1>
                <div>
                    <div class="rounded-full font-bold bg-blue-resolute-dark text-white px-3 py-1 text-xs uppercase tracking-wide">Active</div>
                </div>
            </div> <!-- end heading-section -->

            <div class="text-sm text-grey-darker mb-4">
                123 Main St., Galvenston, TX 77555
            </div>

            <div class="card-details bg-white border border-grey-light border-solid border-t-4 border-t-blue-resolute rounded px-4 py-6 mb-8">
                <div class="flex">
                    ...
                    <div class="w-2/3 pl-8">
                        <div class="flex flex-wrap">
                            <div class="w-1/2 pr-4 mb-6">
                                ...
                                <input id="pid" type="text" value="GALDZO2R4I5ZK" class="w-full text-base bg-grey-lightest  border border-solid border-grey-light text-grey-darkest outline-0 rounded px-3 py-3">
                            </div>
                            <div class="w-1/2">
                                <label for="cad_owner_name" class="block text-grey-darkest text-base mb-2">CAD Owner Name</label>
                                <input id="cad_ownder_name" type="text" value="Bart Simpson" class="w-full text-base bg-grey-lightest border border-solid border-grey-light text-grey-darkest outline-0 rounded px-3 py-3">
                            </div>
                            <div class="w-full mb-6">
                                <label for="protest_address" class="block text-grey-darkest text-base mb-2">Protest Address</label>
                                <input id="protest_address" type="text" value="123 Main St., Galvenston, TX 77555" class="w-full text-base bg-grey-lightest  border border-solid border-grey-light text-grey-darkest outline-0 rounded px-3 py-3">
                            </div>
                            <div class="w-full mb-6">
                                <label for="cad_mailing_address" class="block text-grey-darkest text-base mb-2">CAD Mailing Address</label>
                                <input id="cad_mailing_address" type="text" value="123 Main St., Galvenston, TX 77555" class="w-full text-base bg-grey-lightest  border border-solid border-grey-light text-grey-darkest outline-0 rounded px-3 py-3">
                            </div>
                            <div class="w-1/3 mb-6">
                                <label for="fee_rate" class="block text-grey-darkest text-base mb-2">Fee Rate</label>
                                <input id="fee_rate" type="text" value="40" class="w-full text-base bg-grey-lightest border border-solid border-grey-light text-grey-darkest outline-0 rounded px-3 py-3">
                            </div>
                            <div class="w-1/3 mb-6 pl-4">
                                <label for="start_year" class="block text-grey-darkest text-base mb-2">Start Year</label>
                                <input id="start_year" type="text" value="2018" class="w-full text-base bg-grey-lightest border border-solid border-grey-light text-grey-darkest outline-0 rounded px-3 py-3">
                            </div>
                            <div class="w-1/3 mb-6 pl-4">
                                <label for="agency_end_date" class="block text-grey-darkest text-base mb-2">Agency End Date</label>
                                <input id="agency_end_date" type="text" class="w-full text-base bg-grey-lightest  border border-solid border-grey-light text-grey-darkest outline-0 rounded px-3 py-3">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-flags bg-white border border-grey-light border-solid border-t-4 border-t-blue-resolute rounded px-4 py-6 mb-8">
                <div class="flex">
                    <div class="w-1/3 pr-4">
                        <h2 class="text-lg font-semibold mb-4">Flags</h2>
                        <p class="text-black text-sm leading-normal mb-4">Flags are just like tags. We have "flags" for many common situations where a property might require extra attention. </p>
                    </div>
                    <div class="w-2/3 pl-8">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="flex">
                                        ...
                                        <div class="text-red font-bold">Harvey</div>
                                    </div>
                                </td>
                                <td>
                                    <div class="text-sm leading-tight mb-2">Fence fell over in Hurricane Harvey</div>
                                    <div class="text-xs text-grey-dark leading-tight">Applied by Aaron on April 15, 2018 10:37 AM</div>
                                </td>
                            </tr>
                            <tr>
                                <td><input type="checkbox"></td>
                                ...
                                <td>
                                    <div class="flex">
                                        ...
                                        <div class="text-red font-bold">Litigation</div>
                                    </div>
                                </td>
                                <td>
                                    <div class="text-sm leading-tight mb-2">N / A</div>
                                    <div class="text-xs text-grey-dark leading-tight">Applied by System on April 4, 2018 8:13 AM</div>
                                </td>
                            </tr>
                            </tbody>
                        </table>
                        <div class="p-2 bg-grey-lighter mb-4">
                            <a href="#" class="text-xs font-bold text-grey-dark">Show 2 older flags</a>
                        </div>
                        <div>
            ...
            <div class="card-aoas bg-white border border-grey-light border-solid border-t-4 border-t-blue-resolute rounded px-4 py-6 mb-8">
                <div class="flex">
                    <div class="w-1/3 pr-4">
                        <h2 class="text-lg font-semibold mb-4">AOAs</h2>
                        <p class="text-black text-sm leading-normal mb-4">Here you'll see all the AOAs we've ever had for this property. The active one is at the top, the rest are just there for auditing purposes.</p>
                    ...
                    <div class="w-2/3 pl-8">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="text-sm mb-2 leading-tight">If there’s a problem with this AOA, you can <a href="#">make an AOA issue</a>.</div>
                                    <div class="text-xs text-grey-dark leading-tight">Applied by System on April 15, 2018 10:37 AM</div>
                                </td>
                            </tr>

                            </tbody>
                        </table>
                        <div class=""><a href="#" class="uppercase tracking-wide font-bold text-xs text-black">+ Create New AOA</a></div>
                    </div>
                </div>
            </div> <!-- end card-aoas -->

            <div class="card-cancel bg-white border border-grey-light border-solid border-t-4 border-t-red rounded px-4 py-6 mb-8">
                <div class="flex">
                    <div class="w-1/3 pr-4">
                        <h2 class="text-lg font-semibold">Cancel</h2>
                    </div>
                    <div class="w-2/3 pl-8">
                        <div class="card-alert bg-yellow-lightest text-yellow-darker border border-grey-light border-solid border-t-4 border-t-yellow rounded px-4 py-4 mb-6 flex">
                            <div class="mr-2">
                            ...
                            <div class="alert text-sm leading-normal">Heads up! The dealine for cancelling is 11:59pm on Mar 31, 2018. If the client tries to concel after that date, tell them it’s not possible becuase we may have worked their account already.</div>
                        </div> <!-- end card-alert -->
                        <form action="#">
                            <div class="mb-6">
                                <label for="reason" class="block text-grey-darkest text-base mb-2">Reason</label>
                                <input id="reason" type="text" class="w-full text-base bg-grey-lightest border border-solid border-grey-light text-grey-darkest outline-0 rounded px-3 py-3">
                            </div>
                            <div class="mb-6">
                                <label for="notes" class="block text-grey-darkest text-base mb-2">Notes</label>
                                <textarea name="notes" id="notes" rows="3" class="w-full text-base bg-grey-lightest border border-solid border-grey-light text-grey-darkest outline-0 rounded px-3 py-3"></textarea>
                            </div>
                            ...
                            <div class="mb-4 pb-4 border-b-2 border-solid border-grey-light">
                                <label class="flex text-sm leading-normal">
                            ...
                            <div class="text-right">
                                <button type="submit" class="bg-red text-white text-sm rounded font-bold px-4 py-4 hover:bg-red-dark">Cancel This Property</button>
                            </div>
                        </form> <!-- end form -->
                    </div>
                </div>
    ...
    <div class="right-sidebar w-right bg-white shadow">
        <div class="flex justify-between mb-2 p-4">
            <h2 class="text-lg text-grey-darkest font-semibold">Notes</h2>
            <button class="bg-white uppercase text-grey-darkest text-xs font-bold tracking-wide rounded border border-solid border-grey-light px-3 py-2 hover:text-white hover:bg-grey-darkest">+ New Note</button>
        </div>
        <div class="flex items-center justify-between text-sm font-semibold border-b border-solid border-grey-light px-4 mb-4">
            <a href="#" class="text-grey-darkest border-b-4 border-solid border-blue-resolute pb-4">Notes Only</a>
            <a href="#" class="text-grey-darkest border-b-4 border-solid border-white pb-4">Audits Only</a>
            <a href="#" class="text-grey-darkest border-b-4 border-solid border-white pb-4">Everything</a>
        </div>
