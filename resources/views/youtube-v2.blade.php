...
<nav class="top-bar bg-white shadow w-full px-8 py-3 flex">
    <div class="w-1/6 flex items-center">
        <div class="mr-8"><a href="#"><i class="fa fa-bars text-grey-dark"></i></a></div>
        <div>
            <a href="javascript:void(0)">
                <svg viewBox="0 0 200 60" focusable="false"
                     class="w-24 style-scope ytd-topbar-logo-renderer">
    ...
    <div class="w-1/6"></div>
    <div class="w-2/6 flex items-center flex-1">
        <form class="flex w-full">
            <input type="text" class="w-full border border-grey outline-0 p-2" placeholder="Search"/>
            <button class="border-t border-r border-b border-grey py-2 px-6 bg-grey-lighter hover:bg-grey-light">
    ...
    <div class="w-1/6 flex items-center justify-end">
        <div class="flex items-center justify-between">
            <a href="javascript:void(0)">
                <i class="fa fa-upload text-grey-darker p-2 mr-8"></i>
            </a>
            <a href="javascript:void(0)">
                <i class="fa fa-calendar-o text-grey-darker p-2 mr-8"></i>
            </a>
            <a href="javascript:void(0)">
                <i class="fa fa-bell-o text-grey-darker p-2 mr-8"></i>
            </a>
...
<div class="body border-r-2 border-grey-light min-h-screen flex">
    ...
    <div class="container mx-auto py-4 px-8">
        ...
        <div class="mb-6">
            <a href="#" class="uppercase text-sm font-medium text-grey hover:text-grey-dark">Show More</a>
        </div>
        ...
        <div class="flex justify-between items-center mb-6">
            <div class="flex items-center">
                <a href="#" class="flex items-center no-underline">
                    <img src="/img/youtube/avatar1.jpg" alt="avatar" class="rounded-full w-8 mr-2">
                    <span class="font-semibold text-black">TubeBuddy</span>
                </a>
                <a href="#" class=""></a>
            </div>
            <a href="#">
                <div class="text-2xl font-light text-grey-dark hover:text-grey-darkest">×</div>
            </a>
        </div>
        ...
        <div class="flex justify-between items-center mb-6">
            <div class="flex items-center">
                <a href="#" class="flex items-center no-underline">
                    <img src="/img/youtube/avatar2.jpg" alt="avatar" class="rounded-full w-8 mr-2">
                    <span class="font-semibold text-black">Andre Madarang</span>
                </a>
                <a href="#" class=""></a>
            </div>
            <a href="#">
        ...
        <div class="flex flex-row mb-4">
            <a href="#" class="relative mr-4 mb-1">
                <img src="/img/youtube/thumbnail13.jpg" alt="thumb" class="transition-slow hover:opacity-75">
                <div class="absolute pin-b pin-r text-xs text-white bg-black opacity-85 p-1 rounded mx-1 my-2 leading-tight">
                    41:42
                </div>
            ...
            <div class="w-128 max-w-full">
                <div class="text-black mb-1">Machine Learning Tutorial for Beginners - USING JAVASCRIPT!</div>
                <div class="text-sm mb-3">
                    <div class="text-sm">
                        <a href="#" class="text-grey-dark hover:text-black">
                            DashieGames <i class="fa fa-check-circle mr-1"></i>
                            <span class="text-sm text-grey-dark">618K views · 2 days ago</span>
                        </a>
                    </div>
                </div>
                <div class="text-sm">
                    <a href="#" class="text-grey-dark leading-normal">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsa ad temporibus explicabo,
                            possimus labore non atque eveniet id modi inventore reprehenderit deleniti. Porro alias illo
                            minima ratione. Quos possimus, natus.</p>
                    </a>
                </div>
            </div>
        </div>
