    ...
    <div class="col-span-12 lg:col-span-10 flex flex-col lg:flex-row items-center justify-between">
        <div>
            <form action="#" class="flex">
                ...
                <button type="submit"
                        class="border-t border-r border-b border-grey py-2 px-6 bg-grey-lighter hover:bg-grey-light">
...
<div class="youtube-body grid grid-columns-12">
    ...
    <div class="youtube-videos col-span-12 lg:col-span-10 container mx-auto py-6 px-4">
        <div class="font-semibold mb-6">
            Recommended
        </div>
        <div class="grid grid-columns-1 lg:grid-columns-5 grid-gap-4 mb-6">
            <div>
                <a href="#"><img src="/img/youtube/thumbnail01.jpg" alt="thumb"
                                 class="mb-1 transition-slow hover:opacity-75"></a>
                <div class="text-sm mb-2"><a href="#" class="text-black">PIGGY PIGGY DUDE ON NIGHTMARE MODE!!</a></div>
                <div class="text-sm"><a href="#" class="text-grey-dark hover:text-black">DashieGames <i
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="#">
                <div class="text-2xl font-light text-grey-dark hover:text-grey-darkest">&times;</div>
            </a>
        </div>
        ...
        <div class="flex flex-col lg:flex-row">
            <a href="#" class="mr-4"><img src="/img/youtube/thumbnail01.jpg" alt="thumb"
                                          class="mb-1 transition-slow hover:opacity-75"></a>
            <div class="w-128 max-w-full">
                <div class="mb-1"><a href="#" class="text-black">Machine Learning Tutorial for Beginners - USING
                        JAVASCRIPT!</a></div>
                <div class="text-sm mb-3"><a href="#" class="text-grey-dark hover:text-black">DashieGames &middot; 12K
                        views &middot; 3 months ago <i class="fa fa-check-circle"></i></a></div>
                <div class="text-sm"><a href="#" class="text-grey-dark leading-normal">Lorem ipsum dolor sit amet,
                        consectetur adipisicing elit. Ipsa ad temporibus explicabo, possimus labore non atque eveniet id
                        modi inventore reprehenderit deleniti. Porro alias illo minima ratione. Quos possimus,
                        natus.</a></div>
            </div>
